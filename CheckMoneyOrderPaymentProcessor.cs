...
namespace Nop.Plugin.Payments.CheckMoneyOrder.Luminor
{
    /// <summary>
    ...
    public class CheckMoneyOrderPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public CheckMoneyOrderPaymentProcessor(CheckMoneyOrderLuminorPaymentSettings checkMoneyOrderPaymentSettings,
        ...
        {
            return $"{_webHelper.GetStoreLocation()}Admin/PaymentCheckMoneyOrderLuminor/Configure";
        }
        ...
        {
            return "CheckMoneyOrder.Luminor";
        }
        ...
        {
            //settings
            var settings = new CheckMoneyOrderLuminorPaymentSettings
            {
        ...
        {
            //settings
            await _settingService.DeleteSettingAsync<CheckMoneyOrderLuminorPaymentSettings>();

            //locales
            await _localizationService.DeleteLocaleResourcesAsync("Plugins.Payment.CheckMoneyOrder.Luminor");
