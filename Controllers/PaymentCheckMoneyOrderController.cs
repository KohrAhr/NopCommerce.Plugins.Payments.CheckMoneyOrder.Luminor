...
namespace Nop.Plugin.Payments.CheckMoneyOrder.Luminor.Controllers
{
    [AuthorizeAdmin]
    [Area(AreaNames.Admin)]
    [AutoValidateAntiforgeryToken]
    public class PaymentCheckMoneyOrderLuminorController : BasePaymentController
    {
        #region Fields
        ...
        public PaymentCheckMoneyOrderLuminorController(ILanguageService languageService,
        ...
        public async Task<IActionResult> Configure()
        {
            ...
            var checkMoneyOrderPaymentSettings = await _settingService.LoadSettingAsync<CheckMoneyOrderLuminorPaymentSettings>(storeScope);
            ...
            return View("~/Plugins/Payments.CheckMoneyOrder.Luminor/Views/Configure.cshtml", model);
        }
